...
const updateShowModal = document.getElementById("updateShowModal")
const updateHideModal = document.getElementById("updateHideModal")
var update = new bootstrap.Modal(document.getElementById("updateModal"));
...
updateShowModal.addEventListener("click", function() {
  update.show();
});
updateHideModal.addEventListener("click", function() {
  update.hide();
}); */


function showModal(modal,hide){
